    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Access restricted - HR permissions required</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="space-y-4 pr-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select onValueChange={(value) => handleInputChange("seniorityLevel", value)}>
                  <SelectTrigger>
              ...
              <div>
                ...
                <Select onValueChange={(value) => handleInputChange("onNoticePeriod", value)}>
                  <SelectTrigger>
